...
namespace gfx {
    ...
    void Invoke(std::string_view menuPath, std::string target) {
        ...
        auto* args = RE::MakeFunctionArguments((std::string)menuPath, (std::string)target);
        RE::BSTSmartPointer<RE::BSScript::IStackCallbackFunctor> result;
        result.reset();
        vm->DispatchStaticCall("UI", "Invoke", args, result);
    } 
    ...
    void InvokeString(std::string_view menuPath, std::string target, std::string arg) {
        auto* vm = RE::BSScript::Internal::VirtualMachine::GetSingleton();
        auto* args = RE::MakeFunctionArguments((std::string)menuPath, (std::string)target, (std::string)arg);
        RE::BSTSmartPointer<RE::BSScript::IStackCallbackFunctor> result;
        result.reset();
        vm->DispatchStaticCall("UI", "InvokeString", args, result);
    } 
    ...
    void SetString(std::string_view menuPath, std::string target, std::string arg) {
        ...
        RE::BSTSmartPointer<RE::BSScript::IStackCallbackFunctor> result;
        result.reset();
        vm->DispatchStaticCall("UI", "SetString", args, result);
    }
